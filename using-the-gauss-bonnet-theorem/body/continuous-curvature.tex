...
Then $I=ds^2=Edu^2+2Fdudv +Gdv^2$ is called the \EMPH{first fundamental form}.
...
\todo{revisit second fundamental form}
...
Then \EMPH{second fundamental form} is $II=Ldu^2+2Mdudv+Ndv^2$.
