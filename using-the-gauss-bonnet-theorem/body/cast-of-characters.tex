...
\subsection{Manifolds, Curvature, and the Euler Characteristic}
\label{sec:cast}

\cite{orourke_computational_1994}
...
A spherical \EMPH{lune} is the area on a sphere bounded by two half great circles.
...
See \figref{switcheroo} for a visual proof.


\begin{figure}[htb]
\centering
\includegraphics[width=.3\textwidth]{sec-1-and-2/switch-angles}
