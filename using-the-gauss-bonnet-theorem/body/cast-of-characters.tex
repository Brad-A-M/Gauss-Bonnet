...
The curvature is how much $\vec{T}=(x'(t),y'(t),z'(t))$ is rotating. 
This is exactly the second derivative $B=\gamma''$. Since we traverse $\gamma$
...
Let $n$ denote a normal vector parallel to $\gamma''$, that is $\gamma''=k n$.
