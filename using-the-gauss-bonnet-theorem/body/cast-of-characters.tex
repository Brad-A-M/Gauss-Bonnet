...
Our applications will use the Euler characteristic of triangulated two spheres and disks.
The Euler characteristic of a disk is one, a filled in triangle has three vertices three
edges and one face.
The Euler characteristic of a triangulated sphere is $2$, Eppstein maintains a 
