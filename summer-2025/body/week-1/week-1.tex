...
For generalization (3), we will share versions of \thmref{g-b-noboundary} for smooth
...
Two  celebrated generalizing \thmref{g-b-noboundary} to higher dimensions are the Chern-Gauss-Bonnet theorem\cite{chern_simple_1944}, which we
