...
In this section, we introduce both smooth and discrete notions of curvature. 
...
\item the sphere has curvature one
...
So, the sphere approximation is not the best way to go.
...
The intersection of the surface and each normal plane 
...
bends sharply, if the normal changes slowly, the surface is nearly flat.
