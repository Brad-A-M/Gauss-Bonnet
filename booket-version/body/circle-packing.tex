...
More generally,  they showed that a if $G$ has a `large' number of vertices with 'large' degree
...
given in \thmref{CPGB} tells us that 
...
\begin{enumerate}
	\item Find a circle packing that illustrates that \eqnref{He-Sch-hyper} is not tight.
